    ...
    $.extend(Wickedpicker.prototype, {
        ...
        showPicker: function (element) {
            ...
            this.timepicker.css({
                ...
                top: timepickerPos.top + element[0].offsetHeight - 134
            }).show();
        ...
        createPicker: function () {
            if ($('.wickedpicker').length === 0) {
                var picker = '<div class="wickedpicker"><i class="fa fa-times" id="close-wickedpicker" aria-hidden="true"></i><p class="wickedpicker__title">' + this.options.title + '</p><ul class="wickedpicker__controls"><li class="wickedpicker__controls__control"><span class="' + this.options.upArrow + '"><i class="fa fa-angle-up" aria-hidden="true"></i></span><span class="wickedpicker__controls__control--hours" tabindex="-1">00</span><span class="' + this.options.downArrow + '"><i class="fa fa-angle-down" aria-hidden="true"></i></span></li><li class="wickedpicker__controls__control--separator"><span class="wickedpicker__controls__control--separator-inner">:</span></li><li class="wickedpicker__controls__control"><span class="' + this.options.upArrow + '"><i class="fa fa-angle-up" aria-hidden="true"></i></span><span class="wickedpicker__controls__control--minutes" tabindex="-1">00</span><span class="' + this.options.downArrow + '"><i class="fa fa-angle-down" aria-hidden="true"></i></span></li>';
                if (this.options.showSeconds) {
                ...
                picker += '<li class="wickedpicker__controls__control"><span class="' + this.options.upArrow + '"><i class="fa fa-angle-up" aria-hidden="true"></i></span><span class="wickedpicker__controls__control--meridiem" tabindex="-1">AM</span><span class="' + this.options.downArrow + '"><i class="fa fa-angle-down" aria-hidden="true"></i></span></li></ul></div>';
                $('body').append(picker);
...
if (url == "aviplaceholder.png") {
		var aviUrl = "/assets/aviplaceholder-aaa8081b30cef10e7726c12f6296bc07271c511f472c82c6dca7dbe9bbf8148d.png";
	} else {
		var aviUrl = url;
	}
